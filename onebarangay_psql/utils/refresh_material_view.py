    ...
    with connection.cursor() as cursor:
        cursor.execute(
            """REFRESH MATERIALIZED VIEW CONCURRENTLY materialized_statistics_total; REFRESH
                       ...
                       materialized_statistics_user_login; REFRESH MATERIALIZED VIEW CONCURRENTLY
                       materialized_statistics_user_login_monthly; REFRESH MATERIALIZED VIEW CONCURRENTLY
                       materialized_statistics_age_group; REFRESH MATERIALIZED VIEW CONCURRENTLY
                       materialized_statistics_citizenship; REFRESH MATERIALIZED VIEW CONCURRENTLY
